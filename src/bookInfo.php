...
$query3 = "SELECT AUTHOR_NAME FROM author WHERE ISBN = $isbn";
$query1 = "SELECT language FROM language WHERE ISBN = $isbn";
$query2 = "SELECT subject FROM subject_area WHERE ISBN = $isbn";
